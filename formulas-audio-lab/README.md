...
- **Analyser** — данные для осциллоскопа и RMS-метра
...
- **CLIP / RMS** — индикатор клиппинга и уровень в dBFS
- **Effects** — открыть/закрыть панель эффектов
...
- "Reset state" — сброс внутреннего состояния (фаза, буферы)
...
4. **Reset state** — для Karplus-Strong это "щипок", для Gliss — начало с f0
5. **Запись** — используй Record для сохранения интересных звуков
